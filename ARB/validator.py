...
def main():
    ...
    # EstimationValidator.multi_run("label_k10_le30", max_num_iter=30, early_stop=True, k_index= -1, dataset_names=['cora', 'computers'] ,run_algos=['arb', 'arb_label_25','arb_label_50', 'arb_label_75', 'arb_label_all'])
